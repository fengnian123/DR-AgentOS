...
outside its view. For long-lived embodied agents, the challenge is to infer the
current state from intermittent observations, remain responsive to unobserved
changes during execution, and decide where to gather evidence when that
inference is uncertain. We introduce \evolvingworldnav{}, an embodied agent
