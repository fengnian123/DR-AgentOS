...
before termination. N4 episodes with no realized execution-time transition are
kept as a separate no-transition slice in the aggregate evaluation; paired
static, routine, and random controls are reported in
\cref{tab:worlds}.
...
\begin{figure}[!t]
    \centering
    \includegraphics[width=0.70\columnwidth]{figures/core_component_ablation_grouped.pdf}
