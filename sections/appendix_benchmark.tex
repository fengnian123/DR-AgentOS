...
\evofourbench{} follows four principles: temporal continuity, past-only observability,
...
\begin{table}[!htbp]
\caption{Mobility regimes in \evofourbench{}.}
...
\begin{table}[!htbp]
\caption{Prediction and navigation protocols in \evofourbench{}.}
\label{tab:tasks}
\centering
\scriptsize
\setlength{\tabcolsep}{3.5pt}
