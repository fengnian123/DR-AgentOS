...
sampling are benchmark-authored and labeled as such. No source trajectory
...
intended object without answer-correlated names or future-state hints. Each task
is also checked to ensure that it probes stale observations, hidden evolution,
predictive belief, or visibility-aware evidence updates, rather than reducing
to a static or trivially solvable navigation case. Reviewers assign accept,
revise, or reject decisions; disagreements are resolved by majority vote,
while unresolved or high-risk cases are adjudicated
