...
Every retained benchmark episode undergoes two stages of human quality control. Five trained researchers perform the primary annotation using a
...
scene geometry and visibility model, and a transition time between the
relevant observations. Reviewers also check that public records do not expose
future information and record whether the reason for relocation is consistent
with the attributed activity,
...
each task is checked to ensure that it addresses the evaluation setting---stale
